...
export default function NewTripPage() {
  ...
  return (
    <div className="max-w-lg">
      <Link href="/trips" className="inline-flex items-center gap-1.5 text-sm text-stone-500 hover:text-stone-800 mb-6 transition-colors">
        <ArrowLeft className="h-4 w-4" /> Back to trips
      </Link>
      <h1 className="text-xl font-bold text-stone-800 mb-6">Create New Trip</h1>
